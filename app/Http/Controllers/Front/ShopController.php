...
class ShopController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $product = Productss::finOrFail($id);
        ...
        $relatedProducts = Productss::where('product_category_id', $product->product_category_id)
    ...
    public function index(Request $request) {
        ...
        $products = Productss::where('name', 'like', '%' . $search . "%");
